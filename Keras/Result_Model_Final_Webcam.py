...
from image_commons import image_as_nparray, nparray_as_image, draw_with_alpha
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        for c in range(0, 3):
            frame[y:y + h, x:x + w, c] = image_array[:, :, c] * (image_array[:, :, 3] / 255.0) \
                                                + frame[y:y + h, x:x + w, c] * (1.0 - image_array[:, :, 3] / 255.0)
